...
$data = $objQuery->index("SELECT * FROM mst_shareholder WHERE IsDeleted=0 ORDER BY Id ASC");
?>
<div class="table-container">
    ...
    <table class="table table-hover datatable">
        <thead><tr><th>SL</th><th>ID</th><th>Name (EN)</th><th>Name (BN)</th><th>Mobile</th><th>Investment</th><th>Status</th><th>Actions</th></tr></thead>
...
<div class="modal fade" id="addModal" tabindex="-1"><div class="modal-dialog modal-lg"><div class="modal-content">
    <form id="dataForm" method="POST" action="../../modules/entry/shareholder_entry.php">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-4 mb-3"><label class="form-label">Shareholder ID</label><input type="text" name="shareholder_id" id="shareholder_id" class="form-control"></div>
