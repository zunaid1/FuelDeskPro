...
<div class="modal fade" id="addModal" tabindex="-1"><div class="modal-dialog modal-lg"><div class="modal-content">
    <form id="dataForm" method="POST" action="../../modules/entry/nozzle_reading_entry.php">
        ...
        <div class="modal-header"><h5 class="modal-title fs-5 fw-bold" id="modalTitle"><i class="fas fa-plus-circle me-2"></i>Add New Reading</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card p-3 h-100" style="border: 2.5px solid #4169e1; border-radius: 8px; background-color: #f8faff;">
                        <h5 class="section-title mb-3" style="color: #4169e1;"><i class="fas fa-globe me-1"></i> General Reading (সাধারণ রিডিং)</h5>
                        
                        <div class="mb-3">
                            <label class="form-label">General Reading <span class="text-danger">*</span></label>
                            <input type="number" step="0.001" name="general_reading" id="general_reading" class="form-control" style="background-color: #e7f1ff; border: 2px solid #4169e1;" required>
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label">Previous General</label>
                            <input type="number" step="0.001" name="prev_general" id="prev_general" class="form-control" style="background-color: #f0f7ff; border: 1.5px solid #cce0ff;" <?php echo $isMeterReadingReadOnly ? 'readonly' : ''; ?>>
                        </div>
                        
                        <div class="mb-0">
                            <label class="form-label" style="color: #4169e1;">Diff. General</label>
                            <input type="number" step="0.001" name="diff_general" id="diff_general" class="form-control" style="background-color: #d0e1fd; border: 1.5px solid #a3c4f3;" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card p-3 h-100" style="border: 2.5px solid #000000; border-radius: 8px; background-color: #fcfcfc;">
                        <h5 class="section-title text-dark mb-3"><i class="fas fa-cog me-1"></i> Master Reading (মাষ্টার রিডিং)</h5>
                        
                        <div class="mb-3">
                            <label class="form-label">Master Reading <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.001" name="prev_master" id="prev_master" class="form-control" style="background-color: #f8f9fa; border: 1.5px solid #dcdcdc;" <?php echo $isMeterReadingReadOnly ? 'readonly' : ''; ?>>
                        </div>
                        
                        <div class="mb-0">
                            <label class="form-label text-dark">Diff. Master</label>
                            <input type="number" step="0.001" name="diff_master" id="diff_master" class="form-control" style="background-color: #e2e2e2; border: 1.5px solid #b5b5b5;" readonly>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button><button type="submit" class="btn btn-primary fs-6 fw-bold"><i class="fas fa-save me-1"></i> Save</button></div>
    </form>
</div></div></div>
